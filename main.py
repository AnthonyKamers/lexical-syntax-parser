...
if __name__ == '__main__':
    ...
    # analisador = AnalisadorSintatico(lexico)
    # analisador.set_grammar("entradas/gramaticas/exemplo-ll1-valido1.grammar")
    # analisador.build()
    # print(analisador.run_entrada("dadbd"))

    # grammar = Grammar()
    # grammar.parse_file("entradas/gramaticas/variavel.grammar")
    # print("")
